...
obese_cost_pre=summaryBy(obese~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6] #other non-hisp, hisp, asian, black, white; mean then sd
chd_cost_pre=summaryBy(chd~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
str_cost_pre=summaryBy(str~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
dm_cost_pre=summaryBy(dm~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
ckd_cost_pre=summaryBy(ckd~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
den_cost_pre=summaryBy(den~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
obese_cost_post=summaryBy(obese_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
chd_cost_post=summaryBy(chd_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
str_cost_post=summaryBy(str_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
dm_cost_post=summaryBy(dm_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
ckd_cost_post=summaryBy(ckd_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
den_cost_post=summaryBy(den_post~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
obese_cost_postmpre=summaryBy(obese_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
chd_cost_postmpre=summaryBy(chd_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
str_cost_postmpre=summaryBy(str_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
dm_cost_postmpre=summaryBy(dm_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
ckd_cost_postmpre=summaryBy(ckd_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]
den_cost_postmpre=summaryBy(den_postmpre~white+black+asian+other+hisp,data = dfcostsper10k,FUN=c(mean))[,6]


obese_cost_pre_class = summaryBy(obese~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_pre_class = summaryBy(chd~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_pre_class = summaryBy(str~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_pre_class = summaryBy(dm~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_pre_class = summaryBy(ckd~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_pre_class = summaryBy(den~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_cost_post_class = summaryBy(obese_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_post_class = summaryBy(chd_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_post_class = summaryBy(str_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_post_class = summaryBy(dm_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_post_class = summaryBy(ckd_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_poso_class = summaryBy(den_post~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_cost_postmpre_class = summaryBy(obese_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_postmpre_class = summaryBy(chd_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_postmpre_class = summaryBy(str_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_postmpre_class = summaryBy(dm_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_postmpre_class = summaryBy(ckd_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_postmpre_class = summaryBy(den_postmpre~mgmt+whcol+blcol,data = dfcostsper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
...
obese_qalys_pre=summaryBy(obese~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6] #other non-hisp, hisp, asian, black, white; mean then sd
chd_qalys_pre=summaryBy(chd~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
str_qalys_pre=summaryBy(str~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
dm_qalys_pre=summaryBy(dm~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
ckd_qalys_pre=summaryBy(ckd~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
den_qalys_pre=summaryBy(den~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
obese_qalys_post=summaryBy(obese_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
chd_qalys_post=summaryBy(chd_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
str_qalys_post=summaryBy(str_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
dm_qalys_post=summaryBy(dm_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
ckd_qalys_post=summaryBy(ckd_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
den_qalys_post=summaryBy(den_post~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
obese_qalys_postmpre=summaryBy(obese_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
chd_qalys_postmpre=summaryBy(chd_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
str_qalys_postmpre=summaryBy(str_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
dm_qalys_postmpre=summaryBy(dm_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
ckd_qalys_postmpre=summaryBy(ckd_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]
den_qalys_postmpre=summaryBy(den_postmpre~white+black+asian+other+hisp,data = dfqalysper10k,FUN=c(mean))[,6]

obese_qalys_pre_class = summaryBy(obese~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_pre_class = summaryBy(chd~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_pre_class = summaryBy(str~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_pre_class = summaryBy(dm~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_pre_class = summaryBy(ckd~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_pre_class = summaryBy(den~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_qalys_post_class = summaryBy(obese_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_post_class = summaryBy(chd_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_post_class = summaryBy(str_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_post_class = summaryBy(dm_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_post_class = summaryBy(ckd_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_poso_class = summaryBy(den_post~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_qalys_postmpre_class = summaryBy(obese_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_postmpre_class = summaryBy(chd_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_postmpre_class = summaryBy(str_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_postmpre_class = summaryBy(dm_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_postmpre_class = summaryBy(ckd_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_postmpre_class = summaryBy(den_postmpre~mgmt+whcol+blcol,data = dfqalysper10k,FUN=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
...
qalys_pre=summaryBy(qalyspre~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]
qalys_post=summaryBy(qalyspost~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]
qalys_postmpre=summaryBy(qalyspostmpre~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]
costs_pre=summaryBy(costspre~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]
costs_post=summaryBy(costspost~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]
costs_postmpre=summaryBy(costspostmpre~white+black+asian+other+hisp,data = dfsub,FUN=c(mean))[,6]

qalys_pre_class=summaryBy(qalyspre~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
qalys_post_class=summaryBy(qalyspost~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
qalys_postmpre_class=summaryBy(qalyspostmpre~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
costs_pre_class=summaryBy(costspre~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
costs_post_class=summaryBy(costspost~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
costs_postmpre_class=summaryBy(costspostmpre~mgmt+whcol+blcol,data = dfsub,FUN=c(mean))[,4]
