...
qalys_post[,j]=summaryBy(qalyspost~white+black+asian+other+hisp,data= dfsub,FUN=c(mean))[,6]
...
costs_post[,j]=summaryBy(costspost~white+black+asian+other+hisp,data= dfsub,FUN=c(mean))[,6]
