...
obese_cost_prep[,j]=summaryBy(obese~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6] #other non-hisp, hisp, asian, black, white; mean then sd
chd_cost_pre[,j]=summaryBy(chd~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
str_cost_pre[,j]=summaryBy(str~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
dm_cost_pre[,j]=summaryBy(dm~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
ckd_cost_pre[,j]=summaryBy(ckd~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
den_cost_pre[,j]=summaryBy(den~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
obese_cost_post[,j]=summaryBy(obese_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
chd_cost_post[,j]=summaryBy(chd_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
str_cost_post[,j]=summaryBy(str_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
dm_cost_post[,j]=summaryBy(dm_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
ckd_cost_post[,j]=summaryBy(ckd_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
den_cost_post[,j]=summaryBy(den_post~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
obese_cost_postmpre[,j]=summaryBy(obese_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
chd_cost_postmpre[,j]=summaryBy(chd_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
str_cost_postmpre[,j]=summaryBy(str_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
dm_cost_postmpre[,j]=summaryBy(dm_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
ckd_cost_postmpre[,j]=summaryBy(ckd_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]
den_cost_postmpre[,j]=summaryBy(den_postmpre~white+black+asian+other+hisp,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,6]


obese_cost_pre_class [,j]= summaryBy(obese~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_pre_class [,j]= summaryBy(chd~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_pre_class [,j]= summaryBy(str~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_pre_class [,j]= summaryBy(dm~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_pre_class [,j]= summaryBy(ckd~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_pre_class [,j]= summaryBy(den~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_cost_post_class [,j]= summaryBy(obese_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_post_class [,j]= summaryBy(chd_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_post_class [,j]= summaryBy(str_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_post_class [,j]= summaryBy(dm_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_post_class [,j]= summaryBy(ckd_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_poso_class [,j]= summaryBy(den_post~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_cost_postmpre_class [,j]= summaryBy(obese_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_cost_postmpre_class [,j]= summaryBy(chd_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_cost_postmpre_class [,j]= summaryBy(str_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_cost_postmpre_class [,j]= summaryBy(dm_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_cost_postmpre_class [,j]= summaryBy(ckd_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_cost_postmpre_class [,j]= summaryBy(den_postmpre~mgmt+whcol+blcol,data [,j]= dfcostsper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
...
obese_qalys_pre[,j]=summaryBy(obese~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6] #other non-hisp, hisp, asian, black, white; mean then sd
chd_qalys_pre[,j]=summaryBy(chd~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
str_qalys_pre[,j]=summaryBy(str~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
dm_qalys_pre[,j]=summaryBy(dm~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
ckd_qalys_pre[,j]=summaryBy(ckd~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
den_qalys_pre[,j]=summaryBy(den~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
obese_qalys_post[,j]=summaryBy(obese_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
chd_qalys_post[,j]=summaryBy(chd_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
str_qalys_post[,j]=summaryBy(str_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
dm_qalys_post[,j]=summaryBy(dm_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
ckd_qalys_post[,j]=summaryBy(ckd_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
den_qalys_post[,j]=summaryBy(den_post~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
obese_qalys_postmpre[,j]=summaryBy(obese_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
chd_qalys_postmpre[,j]=summaryBy(chd_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
str_qalys_postmpre[,j]=summaryBy(str_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
dm_qalys_postmpre[,j]=summaryBy(dm_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
ckd_qalys_postmpre[,j]=summaryBy(ckd_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]
den_qalys_postmpre[,j]=summaryBy(den_postmpre~white+black+asian+other+hisp,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,6]

obese_qalys_pre_class [,j]= summaryBy(obese~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_pre_class [,j]= summaryBy(chd~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_pre_class [,j]= summaryBy(str~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_pre_class [,j]= summaryBy(dm~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_pre_class [,j]= summaryBy(ckd~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_pre_class [,j]= summaryBy(den~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_qalys_post_class [,j]= summaryBy(obese_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_post_class [,j]= summaryBy(chd_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_post_class [,j]= summaryBy(str_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_post_class [,j]= summaryBy(dm_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_post_class [,j]= summaryBy(ckd_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_poso_class [,j]= summaryBy(den_post~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
obese_qalys_postmpre_class [,j]= summaryBy(obese_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
chd_qalys_postmpre_class [,j]= summaryBy(chd_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
str_qalys_postmpre_class [,j]= summaryBy(str_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
dm_qalys_postmpre_class [,j]= summaryBy(dm_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
ckd_qalys_postmpre_class [,j]= summaryBy(ckd_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
den_qalys_postmpre_class [,j]= summaryBy(den_postmpre~mgmt+whcol+blcol,data [,j]= dfqalysper10k,FUN[,j]=c(mean))[,4] #none, blcol, whcol, wh+bl, mgmt
...
qalys_pre[,j]=summaryBy(qalyspre~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]
qalys_post[,j]=summaryBy(qalyspost~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]
qalys_postmpre[,j]=summaryBy(qalyspostmpre~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]
costs_pre[,j]=summaryBy(costspre~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]
costs_post[,j]=summaryBy(costspost~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]
costs_postmpre[,j]=summaryBy(costspostmpre~white+black+asian+other+hisp,data [,j]= dfsub,FUN[,j]=c(mean))[,6]

qalys_pre_class[,j]=summaryBy(qalyspre~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
qalys_post_class[,j]=summaryBy(qalyspost~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
qalys_postmpre_class[,j]=summaryBy(qalyspostmpre~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
costs_pre_class[,j]=summaryBy(costspre~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
costs_post_class[,j]=summaryBy(costspost~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
costs_postmpre_class[,j]=summaryBy(costspostmpre~mgmt+whcol+blcol,data [,j]= dfsub,FUN[,j]=c(mean))[,4]
...
colMeans(df)
colSds(df)
readr::write_csv(as.data.frame(df), path = "~/Box/Analytics Team/Research/Research projects/SSB ban/df.csv")
